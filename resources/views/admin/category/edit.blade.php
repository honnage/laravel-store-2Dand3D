                                ...
                                <form action="{{url('/category/update/'.$category_edit->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12 my-3">
                                            ...
                                            <input type="text" class="col-sm-12 col-form-label form-control"  name="name_th" id="name_th" value="{{ $category_edit->name_th }}">
                                        </div>
                                        ...
                                        <div class="form-group col-xs-12 col-sm-12 col-md-16 my-3">
                                            ...
                                            <input type="text" class="col-sm-12 col-form-label form-control" name="name_en" id="name_en" value="{{ $category_edit->name_en }}">
